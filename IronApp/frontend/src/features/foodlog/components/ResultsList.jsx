...
const ResultsList = ({ 
    ...
    const handleScroll = (e) => {
        ...
        if (scrollHeight - scrollTop <= clientHeight + 50 && !isLoading && currentPage < totalPages) {
    ...
    useEffect(() => {
        if (searchResults.length > 0 && searchResults.length < 5 && currentPage < totalPages && !isLoading) {
            onPageChange(currentPage + 1); 
        }
    }, [searchResults, currentPage, totalPages, isLoading, onPageChange]);
    ...
    return (
        <div className="mt-6 w-full">
            <div className="relative bg-white rounded-xl shadow-md p-6 w-full">
                ...
                <div 
                    className="border border-gray-200 rounded-xl overflow-y-auto shadow-md bg-white w-full max-h-[calc(100vh-350px)] min-h-[250px] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100" 
