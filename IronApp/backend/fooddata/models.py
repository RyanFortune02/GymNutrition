...
class foodproduct(models.Model):
    ...
    last_updated_t = models.TextField(blank=True, null=True)
    last_updated_datetime = models.TextField(blank=True, null=True)
    ...
    energy_kj_100g = models.FloatField(blank=True, null=True)
    energy_kcal_100g = models.FloatField(blank=True, null=True)
    energy_100g = models.FloatField(blank=True, null=True)
    energy_from_fat_100g = models.FloatField(blank=True, null=True)
    fat_100g = models.FloatField(blank=True, null=True)
    saturated_fat_100g = models.FloatField(blank=True, null=True)
    butyric_acid_100g = models.FloatField(blank=True, null=True)
    caproic_acid_100g = models.FloatField(blank=True, null=True)
    caprylic_acid_100g = models.FloatField(blank=True, null=True)
    capric_acid_100g = models.FloatField(blank=True, null=True)
    lauric_acid_100g = models.FloatField(blank=True, null=True)
    myristic_acid_100g = models.FloatField(blank=True, null=True)
    palmitic_acid_100g = models.FloatField(blank=True, null=True)
    stearic_acid_100g = models.FloatField(blank=True, null=True)
    arachidic_acid_100g = models.FloatField(blank=True, null=True)
    behenic_acid_100g = models.FloatField(blank=True, null=True)
    lignoceric_acid_100g = models.FloatField(blank=True, null=True)
    cerotic_acid_100g = models.FloatField(blank=True, null=True)
    montanic_acid_100g = models.FloatField(blank=True, null=True)
    melissic_acid_100g = models.FloatField(blank=True, null=True)
    unsaturated_fat_100g = models.FloatField(blank=True, null=True)
    monounsaturated_fat_100g = models.FloatField(blank=True, null=True)
    omega_9_fat_100g = models.FloatField(blank=True, null=True)
    polyunsaturated_fat_100g = models.FloatField(blank=True, null=True)
    omega_3_fat_100g = models.FloatField(blank=True, null=True)
    omega_6_fat_100g = models.FloatField(blank=True, null=True)
    alpha_linolenic_acid_100g = models.FloatField(blank=True, null=True)
    eicosapentaenoic_acid_100g = models.FloatField(blank=True, null=True)
    docosahexaenoic_acid_100g = models.FloatField(blank=True, null=True)
    linoleic_acid_100g = models.FloatField(blank=True, null=True)
    arachidonic_acid_100g = models.FloatField(blank=True, null=True)
    gamma_linolenic_acid_100g = models.FloatField(blank=True, null=True)
    dihomo_gamma_linolenic_acid_100g = models.FloatField(blank=True, null=True)
    oleic_acid_100g = models.FloatField(blank=True, null=True)
    elaidic_acid_100g = models.FloatField(blank=True, null=True)
    gondoic_acid_100g = models.FloatField(blank=True, null=True)
    mead_acid_100g = models.FloatField(blank=True, null=True)
    erucic_acid_100g = models.FloatField(blank=True, null=True)
    nervonic_acid_100g = models.FloatField(blank=True, null=True)
    ...
    added_sugars_100g = models.FloatField(blank=True, null=True)
    sucrose_100g = models.FloatField(blank=True, null=True)
    glucose_100g = models.FloatField(blank=True, null=True)
    fructose_100g = models.FloatField(blank=True, null=True)
    lactose_100g = models.FloatField(blank=True, null=True)
    maltose_100g = models.FloatField(blank=True, null=True)
    maltodextrins_100g = models.FloatField(blank=True, null=True)
    starch_100g = models.FloatField(blank=True, null=True)
    polyols_100g = models.FloatField(blank=True, null=True)
    erythritol_100g = models.FloatField(blank=True, null=True)
    fiber_100g = models.FloatField(blank=True, null=True)
    soluble_fiber_100g = models.FloatField(blank=True, null=True)
    insoluble_fiber_100g = models.FloatField(blank=True, null=True)
    proteins_100g = models.FloatField(blank=True, null=True)
    casein_100g = models.FloatField(blank=True, null=True)
    serum_proteins_100g = models.FloatField(blank=True, null=True)
    nucleotides_100g = models.FloatField(blank=True, null=True)
    salt_100g = models.FloatField(blank=True, null=True)
    added_salt_100g = models.FloatField(blank=True, null=True)
    ...
    beta_carotene_100g = models.FloatField(blank=True, null=True)
    vitamin_d_100g = models.FloatField(blank=True, null=True)
    vitamin_e_100g = models.FloatField(blank=True, null=True)
    vitamin_k_100g = models.FloatField(blank=True, null=True)
    vitamin_c_100g = models.FloatField(blank=True, null=True)
    vitamin_b1_100g = models.FloatField(blank=True, null=True)
    vitamin_b2_100g = models.FloatField(blank=True, null=True)
    vitamin_pp_100g = models.FloatField(blank=True, null=True)
    vitamin_b6_100g = models.FloatField(blank=True, null=True)
    vitamin_b9_100g = models.FloatField(blank=True, null=True)
    folates_100g = models.FloatField(blank=True, null=True)
    vitamin_b12_100g = models.FloatField(blank=True, null=True)
    biotin_100g = models.FloatField(blank=True, null=True)
    pantothenic_acid_100g = models.FloatField(blank=True, null=True)
    ...
    fruits_vegetables_nuts_100g = models.FloatField(blank=True, null=True)
    fruits_vegetables_nuts_dried_100g = models.FloatField(blank=True, null=True)
    fruits_vegetables_nuts_estimate_100g = models.FloatField(blank=True, null=True)
    fruits_vegetables_nuts_estimate_from_ingredients_100g = models.FloatField(blank=True, null=True)
    collagen_meat_protein_ratio_100g = models.FloatField(blank=True, null=True)
    cocoa_100g = models.FloatField(blank=True, null=True)
    chlorophyl_100g = models.FloatField(blank=True, null=True)
    carbon_footprint_100g = models.FloatField(blank=True, null=True)
    carbon_footprint_from_meat_or_fish_100g = models.FloatField(blank=True, null=True)
    nutrition_score_fr_100g = models.FloatField(blank=True, null=True)
    nutrition_score_uk_100g = models.FloatField(blank=True, null=True)
    glycemic_index_100g = models.FloatField(blank=True, null=True)
    water_hardness_100g = models.FloatField(blank=True, null=True)
    choline_100g = models.FloatField(blank=True, null=True)
    phylloquinone_100g = models.FloatField(blank=True, null=True)
    beta_glucan_100g = models.FloatField(blank=True, null=True)
    inositol_100g = models.FloatField(blank=True, null=True)
    carnitine_100g = models.FloatField(blank=True, null=True)
    sulphate_100g = models.FloatField(blank=True, null=True)
    nitrate_100g = models.FloatField(blank=True, null=True)
    acidity_100g = models.FloatField(blank=True, null=True)
